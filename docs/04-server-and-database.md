...
worst case, 128 kbps more inbound for the sharer and 128 kbps outbound per other
participant, and twice that with the audio redundancy on, which it is by default
([chapter 16](16-audio-plan.md), steps 1 and 7). In a room of five that is
~0.25 Mbps in and ~1 Mbps out, which next to 3.3 Mbps of picture does not change
how the machine is sized. The measurements
