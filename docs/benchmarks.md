...
```text
CPU, cinco clientes        77,4% de um núcleo
memória, cinco clientes    224 MiB

participante   rtt      jitter   perdidos   fps      resolução
ana (envia)      1 ms   2,0 ms        510      -     -
bruno            4 ms   2,0 ms        553   29,8     1280x720
carla            1 ms   2,0 ms        542   29,8     1280x720
diego            1 ms   2,0 ms        551   29,8     1280x720
elena            1 ms   2,0 ms        536   29,8     1280x720

injetado: 435 de 9.360 pacotes descartados na saída, 1.558 de 33.640 na entrada
reparo:   52 pedidos, 45 pacotes de vídeo faltando, 45 recuperados
```

Os quatro espectadores continuam recebendo 1280x720 a 29,8 FPS, o mesmo número da corrida sem perda.
O áudio perde os pacotes que foram descartados e o Opus preenche as lacunas.
Ninguém cai.

Comparando com a corrida limpa: CPU praticamente igual, e memória de 171 para 224 MiB.
Os 53 MiB a mais são o custo de segurar pacotes para retransmitir e de jitter buffers maiores, e não foram investigados além disso.
...
- `dv::server::sfu::NackRequester` na track de entrada, que faz o mesmo pedido para cima: quando um pacote do compartilhador se perde a caminho do SFU, o SFU pede a retransmissão em vez de deixar o buraco seguir para todos os espectadores.
...
| Perda de pacotes | sobreviver a 5% | 29,8 FPS e chamada de pé com 5% injetados nos dois sentidos |
